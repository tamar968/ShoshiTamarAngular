...
export class ShowcategoryComponent implements OnInit {
  ...
  constructor(private service: ShopsService, private toastr: ToastrService,@Inject(DOCUMENT) private document: Document) { }
  ...
  ngOnInit() {
    this.service.getAllCategories().subscribe((res: WebResult) => {
      ...
      if (this.service.shop != null&&this.document.location.href=="http://localhost:4200/update")
